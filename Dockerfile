...
EXPOSE 8080
CMD ["sh", "-c", "touch database/database.sqlite && php artisan migrate --force && cd public && php -S 0.0.0.0:${PORT:-8080} /app/vendor/laravel/framework/src/Illuminate/Foundation/resources/server.php"]
